#!/usr/bin/env python3
"""
Public backend server for MEDIVISION-XR with complete functionality
"""
import os
import json
import uuid
    ...
    try:
        ...
        for file in files:
            if file.filename:
                ...
                file_sizes.append(len(file.read()) if file else 0)
                # Reset file pointer
                file.seek(0)
        
        # Detect body part from file names
        body_part = 'brain'  # Default to brain for demo
...
def evaluate():
    ...
    try:
        ...
        sessions[session_id]['evaluated_at'] = datetime.now().isoformat()
...
if __name__ == '__main__':
    ...
    print("  GET  /")
    print("  GET  /health")
    print("  GET  /api/labels/<body_part>")
